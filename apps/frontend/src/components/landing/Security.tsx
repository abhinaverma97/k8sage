...
export default function Security() {
  ...
  return (
    <section id="security" className="w-full py-12 sm:py-16 md:py-24 lg:py-32 border-t border-border/60">
      <div className="mx-auto grid w-full items-center gap-8 sm:gap-12 px-4 sm:px-8 md:px-12 lg:grid-cols-12 lg:gap-12 lg:px-16">
        <div className="lg:col-span-6 xl:col-span-6">
          ...
          <h2 className="mt-3 sm:mt-4 text-2xl sm:text-3xl font-semibold tracking-tight text-foreground md:text-4xl lg:text-5xl">
          ...
          <div className="mt-6 sm:mt-8 space-y-3 sm:space-y-4 font-mono text-xs">
            <div className="flex items-start gap-3 rounded border border-border/60 bg-card p-3 sm:p-4">
        ...
        <div className="lg:col-span-6 xl:col-span-6 lg:border-l lg:border-border/60 lg:pl-12">
          <Card className="overflow-hidden border-border/80 bg-card/90 shadow-lg">
            <div className="flex items-center justify-between border-b border-border/80 bg-muted/40 px-3.5 sm:px-4 py-2.5 sm:py-3">
              ...
              <button
                onClick={copyYaml}
                className="flex shrink-0 items-center gap-1.5 rounded border border-border bg-card px-2.5 py-1 font-mono text-xs text-muted-foreground transition hover:text-foreground active:scale-95"
              >
            ...
            <pre className="scrollbar-thin overflow-x-auto p-3.5 sm:p-5 font-mono text-[11px] sm:text-xs leading-relaxed text-secondary-foreground">
              {yamlCode}
            </pre>
          </Card>
        </div>
