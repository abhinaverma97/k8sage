  ...
  return (
    <header className="flex h-16 items-center justify-between border-b border-ink-600 px-5">
      ...
      <div className="flex items-center gap-3">
        <span className="hidden rounded-full border border-ink-600 px-3 py-1 font-mono text-[11px] text-ink-300 md:inline">
          ns: k8sage
        </span>
        <span className="flex items-center gap-2 rounded-full border border-ink-600 bg-ink-900 px-3 py-1 font-mono text-[11px] text-ink-200">
